...
const adminHeader=[
  ...
  { key: 'otrMonth',align:'center',label: 'OTR Month', width: 100, },
...
const columns=auth.isSuperuser?[...adminMaincolumn]:[...userColumns]
  return (
    <>
       {/* First Box*/}
       <Box
 ...
 Export
        ...
        <CSVLink filename="Reactivation_report.csv" headers={csvHeaders} data={csvdatas}
  ref={csvLinkRef}
  target="_blank"/>     
      <Box ><Button 
    sx={{
