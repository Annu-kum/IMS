...
export default function BulkUpload(props) {
  ...
  const sampleFileUrl = `${FRONTEND_BASE_URL}/images/DeactivationSample.xlsx`;
  ...
  const headers = {
    ...
    const downloadSampleFile = async (url) => {
        try {
          ...
          let filename = 'DeactivationSample.xlsx';  // Default filename
  ...
  const handleUpload = async () => {
    ...
    try {
      const response = await api.post(`/deactivation/import`, formData, {
        headers: headers,
      });
                ...
                <DialogContent >
                        ...
                        <Box>
                          <label style={{ fontWeight: 'bolder' }}>Upload Letterhead</label>
                              ...
                              <input type='file' accept='.pdf,.png,.jpeg,jpg' name='file'  onChange={handleLetterHead} required/>  
