  ...
  return (
    ...
    >
      <Stack spacing={1} direction='row' className='ins-buttons'>
        ...
        <CustomButton variant="outlined" size="small" onClick={handleClickOpen} ><AddIcon fontSize="small" sx={{ mr: "10px" }} />Device Entry</CustomButton>
        <Dialog
          fullScreen
          open={open}
          onClose={handleClose}
        ...
        >
          <AppBar sx={{ position: 'relative', background:`linear-gradient(${'#535C91'},${'#fff'})`,boxShadow:'12'}}>
            <Toolbar >
              <IconButton
                edge="start"
                color="inherit"
              ...
              <Typography sx={{ ml: 2, flex: 1 }} variant="h6" component="div" style={{fontFamily:'Arial',fontWeight:800,color:'#233044'}}>
                Deactivated Device Entry
              </Typography>
